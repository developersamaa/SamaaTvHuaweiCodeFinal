...
public class DataCacheUrdu
{
    ...
    public static void saveHomeList(Context context, ContactList tempList)
    {
        ...
        SharedPreferences myPrefs = context.getSharedPreferences("homeprefurdu", Context.MODE_PRIVATE);
        SharedPreferences.Editor prefsEditor = myPrefs.edit();
        prefsEditor.clear();
        prefsEditor.putString("homeListurdu", strObject);
        prefsEditor.commit();
    }
    ...
    public static ContactList retrieveHomeList(Context context)
    {
        Gson gson = new Gson();
        SharedPreferences myPrefs = context.getSharedPreferences("homeprefurdu", Context.MODE_PRIVATE);
        String json = myPrefs.getString("homeListurdu", null);
