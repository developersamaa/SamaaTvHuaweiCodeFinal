...
import com.Samaatv.samaaapp3.Detail_Activity_Editors;
...
public class EditorsChoiceAdapterListing extends RecyclerView.Adapter<EditorsChoiceAdapterListing.ViewHolder>
{
    ...
    public EditorsChoiceAdapterListing(Context context, ArrayList<Contact> contactList)
    {
    ...
    @Override
    public EditorsChoiceAdapterListing.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(EditorsChoiceAdapterListing.ViewHolder viewHolder, final int i)
    {
        ...
        mPublisherAdView.setAdUnitId("/14309701/and-en/editorschoice/and-en.editorschoice.mrec-1");
        ...
        mPublisherAdView1.setAdUnitId("/14309701/and-en/editorschoice/and-en.editorschoice.mrec-7");
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(context, Detail_Activity_Editors.class);
