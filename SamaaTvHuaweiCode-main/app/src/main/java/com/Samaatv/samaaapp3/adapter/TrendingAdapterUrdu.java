...
public class TrendingAdapterUrdu extends RecyclerView.Adapter<TrendingAdapterUrdu.ViewHolder>
{
    ...
    public TrendingAdapterUrdu(Context context, ArrayList<Contact> contactList)
    {
        this.contactList = contactList;
        this.context = context;
    }

    public TrendingAdapterUrdu(Context context, ArrayList<Contact> contactList, String news_id)
    {
        this.contactList = contactList;
        this.context = context;
    ...
    @Override
    public TrendingAdapterUrdu.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(TrendingAdapterUrdu.ViewHolder viewHolder, final int i)
    {
