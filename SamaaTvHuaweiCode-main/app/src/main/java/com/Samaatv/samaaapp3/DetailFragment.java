...
public class DetailFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        Typeface face = Typeface.createFromAsset(getActivity().getAssets(), "font/HelveticaNeue-Light.ttf");
        title.setTypeface(face);

        Typeface face1 = Typeface.createFromAsset(getActivity().getAssets(), "font/HelveticaNeue-Light.ttf");
        desc.setTypeface(face1);

        Typeface face2 = Typeface.createFromAsset(getActivity().getAssets(), "font/HelveticaNeue-Light.ttf");
        desc2.setTypeface(face2);

        Typeface face3 = Typeface.createFromAsset(getActivity().getAssets(), "font/HelveticaNeue-Light.ttf");
        date.setTypeface(face3);

        Typeface face4 = Typeface.createFromAsset(getActivity().getAssets(), "font/HelveticaNeue-Light.ttf");
        outputTextView.setTypeface(face4);
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    if (response.isSuccessful())
                    {
                        ...
                        if (rel_list != null)
                        {
                            ...
                            rel_adapter = new SeeAlsoAdapter(getActivity(), rel_list, newsCatTag);
    ...
    private void setAndProcessingAd()
    {
        if (newsCatTag.contains("National") || newsCatTag.contains("national"))
        {
            ...
            mPublisherAdView.setAdUnitId("/14309701/and-en/pakistan/and-en.pakistan-det.mrec-1");
            ...
            mPublisherAdView1.setAdUnitId("/14309701/and-en/pakistan/and-en.pakistan-det.mrec-2");
        ...
        if (newsCatTag.contains("Global") || newsCatTag.contains("global") || newsCatTag.contains("International") || newsCatTag.contains("international"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(getActivity());
            mPublisherAdView.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/global/and-en.global-det.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(getActivity());
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/global/and-en.global-det.mrec-2");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            mAdView1.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
        ...
        if (newsCatTag.contains("Economy") || newsCatTag.contains("economy"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(getActivity());
            mPublisherAdView.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/economy/and-en.economy-det.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(getActivity());
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/economy/and-en.economy-det.mrec-2");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            mAdView1.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
        ...
        if (newsCatTag.contains("Sports") || newsCatTag.contains("sports"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(getActivity());
            mPublisherAdView.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/sports/and-en.sports-det.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(getActivity());
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/sports/and-en.sports-det.mrec-2");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            mAdView1.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
        ...
        if (newsCatTag.contains("Entertainment") || newsCatTag.contains("entertainment") || array_detail.get(fPos).getCategory().contains("Culture") || array_detail.get(fPos).getCategory().contains("culture"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(getActivity());
            mPublisherAdView.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/entertainment/and-en.entertainment-det.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(getActivity());
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/entertainment/and-en.entertainment-det.mrec-2");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            mAdView1.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
        ...
        if (newsCatTag.contains("Blogs") || newsCatTag.contains("blogs"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(getActivity());
            mPublisherAdView.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/blogs/and-en.blogs-det.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(getActivity());
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/blogs/and-en.blogs-det.mrec-2");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            mAdView1.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
    ...
    private ViewGroup checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup container)
    {
        ...
        if (diagonalInches >= 6.5)
        {
            ...
            rootView = (ViewGroup) inflater.inflate(R.layout.detail_fragment_large, container, false);
        }
        else
        {
            // smaller device
            rootView = (ViewGroup) inflater.inflate(R.layout.detail_fragment, container, false);
        }
        return rootView;
    }
    ...
    public void onResume()
    {
        ...
        SamaaAppAnalytics.getInstance().trackScreenView("Detail SubScreen News English");
        SamaaFirebaseAnalytics.syncSamaaAnalytics(getActivity(), "Detail SubScreen News English");
    }
