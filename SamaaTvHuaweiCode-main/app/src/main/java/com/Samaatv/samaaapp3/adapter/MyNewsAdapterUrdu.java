...
public class MyNewsAdapterUrdu extends RecyclerView.Adapter<MyNewsAdapterUrdu.ViewHolder>
{
    ...
    public MyNewsAdapterUrdu(Context context, ArrayList<Contact> contactList)
    {
        this.contactList = contactList;
        this.context = context;
    }

    public MyNewsAdapterUrdu(Context context, ArrayList<Contact> contactList, String newsId)
    {
        this.contactList = contactList;
        this.context = context;
        this.newsId = newsId;
    ...
    @Override
    public MyNewsAdapterUrdu.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
  ...
  /*  @Override
    ...
    @Override
    public void onBindViewHolder(MyNewsAdapterUrdu.ViewHolder viewHolder, final int i)
    {
