...
public class DetailFragmentEditors extends Fragment
{
    ...
    String t1, d1, desc1, videourl, link, vmob;
    String ytvideo;
    String image_trend;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        jcVideoPlayerStandard = (JCVideoPlayerStandard) rootView.findViewById(R.id.videoplayer_editor);
        ...
        also_recycle = (RecyclerView) rootView.findViewById(R.id.alsowatch_view);
        ...
        also_recycle.setLayoutManager(layoutManager);
        also_recycle.setHasFixedSize(true);
        ...
        //Webservice for Also Watch at the bottom of every editors detail news
        ...
        if (InternetConnection.checkConnection(getActivity()))
        {
            ...
            Call<NewsCategoryList> call = api.getAlsoURL(url);
            call.enqueue(new Callback<NewsCategoryList>()
            {
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    {
                        also_list = response.body().getAlsoWatch();

                        if (also_list != null)
                        {
                            also_adapter = new EditorsChoiceAdapter(getActivity(), also_list);
                            also_recycle.setAdapter(also_adapter);
                            progress.setVisibility(View.GONE);
                        }
                        else
                        {
                            also_list = new ArrayList<Contact>();
                        }
    ...
    private void setAndProcessingAd()
    {
        ...
        mPublisherAdView.setAdUnitId("/14309701/and-en/editorschoice/and-en.editorschoice-det.mrec-1");
        ...
        mPublisherAdView1.setAdUnitId("/14309701/and-en/editorschoice/and-en.editorschoice-det.mrec-2");
    ...
    private ViewGroup checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup container)
    {
        ...
        if (diagonalInches >= 6.5)
        {
            ...
            rootView = (ViewGroup) inflater.inflate(R.layout.detail_fragment_editors_large, container, false);
        }
        else
        {
            // smaller device
            rootView = (ViewGroup) inflater.inflate(R.layout.detail_fragment_editors, container, false);
        }
        return rootView;

    }

    private void videoCheckNPlay()
    {
...
//            mPlayerView.setVisibility(View.GONE);
    ...
    private void playVideos(String videourl, String image)
    {
...
//        mPlayerView.onResume();
        super.onResume();
        SamaaAppAnalytics.getInstance().trackScreenView("Detail SubScreen Editor News English");
        SamaaFirebaseAnalytics.syncSamaaAnalytics(getActivity(), "Detail SubScreen Editor News English");
    }
