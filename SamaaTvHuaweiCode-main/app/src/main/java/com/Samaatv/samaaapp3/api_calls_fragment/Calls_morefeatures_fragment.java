 ...
 */
public class Calls_morefeatures_fragment
{
                    ...
                    if (response.isSuccessful())
                    {
                        if (response.body() != null)
                        {
                            ...
                            if (healthList != null)
                            {
                                ...
                                DataCache.saveHealthList(context, healthList);
                            }
                            else
                            {
                    ...
                    if (response.isSuccessful())
                    {
                        if (response.body() != null)
                        {
                            ...
                            if (lifeList != null)
                            {
                                ...
                                DataCache.saveLifeList(context, lifeList);
                            }
                            else
                            {
                    ...
                    if (response.isSuccessful())
                    {
                        if (response.body() != null)
                        {
                            ...
                            if (socialList != null)
                            {
                                ...
                                DataCache.saveSocialList(context, socialList);
                            }
                            else
                            {
                    ...
                    if (response.isSuccessful())
                    {
                        if (response.body() != null)
                        {
                            ...
                            if (scitechList != null)
                            {
                                ...
                                DataCache.saveSciList(context, scitechList);
                            }
                            else
                            {
                    ...
                    if (response.isSuccessful())
                    {
                        if (response.body() != null)
                        {
                            ...
                            if (weirdList != null)
                            {
                                ...
                                DataCache.saveWeirdList(context, weirdList);
                            }
                            else
                            {
