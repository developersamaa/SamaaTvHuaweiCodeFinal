 ...
 */
public class Calls_entertainment_fragment
{
    static ArrayList<Contact> enter_list;

    public static void callEnterList(final Context context)
    {
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    if (response.isSuccessful())
                    {
                        ...
                        if (enter_list != null)
                        {
                            ...
                            DataCache.saveEnterList(context, enter_list);
                        }
                        else
                        {
