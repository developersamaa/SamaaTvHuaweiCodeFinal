 ...
 */
public class Calls_sport_fragment_urdu
{

    static ArrayList<Contact> sports_list;

    public static void callSportsList(final Context context)
    {
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    if (response.isSuccessful())
                    {
                        ...
                        if (sports_list != null)
                        {
                            ...
                            DataCacheUrdu.saveSportsList(context, sports_list);
                        }
                        else
                        {
