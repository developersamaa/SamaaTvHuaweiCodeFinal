...
public class ListingsAdapter extends RecyclerView.Adapter<ListingsAdapter.ViewHolder>
{
    ...
    public ListingsAdapter(Context context, ArrayList<Contact> contactList)
    {
        this.contactList = contactList;
        this.context = context;
    }

    public ListingsAdapter(Context context, ArrayList<Contact> contactList, String news_id)
    {
        this.contactList = contactList;
        this.context = context;
    ...
    @Override
    public ListingsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    private ViewHolder checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup viewGroup, int i, Context context)
    {
        ...
        if (diagonalInches >= 6.5)
        {
            ...
            {
                View ADView = inflater.inflate(R.layout.list_item_card_taboola_large, viewGroup, false);
        ...
        else
        {
            ...
            {
                View ADView = inflater.inflate(R.layout.list_item_card_taboola, viewGroup, false);
                return new ViewHolder(ADView)
                {
                };
            }
    ...
    @Override
    public void onBindViewHolder(ListingsAdapter.ViewHolder viewHolder, final int i)
    {
    ...
    private void setAndProcessingAd(ViewHolder viewHolder)
    {
        ...
        if (newsCatTag.contains("National") || newsCatTag.contains("national"))
        {
            ...
            mPublisherAdView.setAdUnitId("/14309701/and-en/pakistan/and-en.pakistan.mrec-1");
            ...
            mPublisherAdView1.setAdUnitId("/14309701/and-en/pakistan/and-en.pakistan.mrec-2");
        ...
        if (newsCatTag.contains("Global") || newsCatTag.contains("global") || newsCatTag.contains("International") || newsCatTag.contains("international"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(context);
            mPublisherAdView.setAdSizes(AdSize.BANNER, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/global/and-en.global.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            viewHolder.mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(context);
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/global/and-en.global.mrec-3");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            viewHolder.ad.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        ...
        if (newsCatTag.contains("Economy") || newsCatTag.contains("economy"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(context);
            mPublisherAdView.setAdSizes(AdSize.BANNER, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/economy/and-en.economy.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            viewHolder.mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(context);
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/economy/and-en.economy.mrec-4");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            viewHolder.ad.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
        ...
        if (newsCatTag.contains("Sports") || newsCatTag.contains("sports") || categoryTag.contains("Sports") || categoryTag.contains("sports"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(context);
            mPublisherAdView.setAdSizes(AdSize.BANNER, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/sports/and-en.sports.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            viewHolder.mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(context);
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/sports/and-en.sports.mrec-5");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            viewHolder.ad.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
        ...
        if (newsCatTag.contains("Entertainment") || newsCatTag.contains("entertainment") || categoryTag.contains("Culture") || categoryTag.contains("culture"))
        {
            ...
            PublisherAdView mPublisherAdView = new PublisherAdView(context);
            mPublisherAdView.setAdSizes(AdSize.BANNER, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView.setAdUnitId("/14309701/and-en/entertainment/and-en.entertainment.mrec-1");
            PublisherAdRequest.Builder publisherAdRequestBuilder = new PublisherAdRequest.Builder();
            viewHolder.mAdView.addView(mPublisherAdView);
            mPublisherAdView.loadAd(publisherAdRequestBuilder.build());
            ...
            PublisherAdView mPublisherAdView1 = new PublisherAdView(context);
            mPublisherAdView1.setAdSizes(AdSize.MEDIUM_RECTANGLE, new AdSize(300, 50), new AdSize(300, 100), new AdSize(320, 50), new AdSize(320, 100));
            mPublisherAdView1.setAdUnitId("/14309701/and-en/entertainment/and-en.entertainment.mrec-6");
            PublisherAdRequest.Builder publisherAdRequestBuilder1 = new PublisherAdRequest.Builder();
            viewHolder.ad.addView(mPublisherAdView1);
            mPublisherAdView1.loadAd(publisherAdRequestBuilder1.build());
        }
