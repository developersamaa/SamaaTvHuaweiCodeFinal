 ...
 */
public class Calls_economy_fragment
{

    static ArrayList<Contact> business_list;

    public static void callEconomyList(final Context context)
    {
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    if (response.isSuccessful())
                    {
                        ...
                        if (business_list != null)
                        {
                            ...
                            DataCache.saveEconomyList(context, business_list);
                        }
                        else
                        {
