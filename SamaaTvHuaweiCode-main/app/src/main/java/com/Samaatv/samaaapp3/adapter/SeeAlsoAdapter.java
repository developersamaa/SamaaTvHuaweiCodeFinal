...
public class SeeAlsoAdapter extends RecyclerView.Adapter<SeeAlsoAdapter.ViewHolder>
{
    ...
    public SeeAlsoAdapter(Context context, ArrayList<Contact> contactList)
    {
        this.contactList = contactList;
        this.context = context;
    }

    public SeeAlsoAdapter(Context context, ArrayList<Contact> contactList, String news_id)
    {
        this.contactList = contactList;
        this.context = context;
    ...
    @Override
    public SeeAlsoAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(SeeAlsoAdapter.ViewHolder viewHolder, final int i)
    {
