...
public class SportsNewsUrdu extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    private ListingsAdapterUrdu sports_adapter;
    private ArrayList<Contact> sports_list;
    private View parentView;
    private String sportNewsCat;

    private Boolean isStarted = false;
    private Boolean isVisible = false;

    public SportsNewsUrdu()
    {
    ...
    public void onStart()
    {
        ...
        if (isVisible && isStarted)
        {
            ...
            {
                fetchSportsListPreference();
            }
        }
    }

    private void fetchSportsListPreference()
    {
        sports_list = DataCacheUrdu.retrieveSportsList(getActivity());

        if (sports_list != null)
        {

            sports_adapter = new ListingsAdapterUrdu(getActivity(), sports_list, "Sports");
            sports_recycle.setAdapter(sports_adapter);

            DevicePreference.getInstance().setmContext(getActivity());
            DevicePreference.getInstance().setSportsList(sports_list);
        ...
        {
            sports_list = new ArrayList<Contact>();
        }
    ...
    private void setData()
    {
        ...
        {
            ArrayList<Contact> tempList = DevicePreference.getInstance().getSportsList();
            if (tempList != null)
            {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        sports_recycle = (RecyclerView) view.findViewById(R.id.recyclerView);
        ...
        sports_recycle.setLayoutManager(layoutManager);
    ...
    public void setArguments(Bundle args)
    {
        ...
        sportNewsCat = args.getString("sportnews");
        DevicePreference.getInstance().setNewsCat(sportNewsCat);
    }
    ...
    public void onResume()
    {
        ...
        new Handler().postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                SamaaAppAnalytics.getInstance().trackScreenView("Sports News Urdu");
                SamaaFirebaseAnalytics.syncSamaaAnalytics(getActivity(), "Sports News Urdu");
            }
        }, 6000);
    ...
    private void fetchSportsList()
    {
        if (InternetConnection.checkConnection(getActivity()))
        {

            ApiService api = RetroClient.getApiService();
            Call<NewsCategoryList> call = api.getSportsNewsUrdu();
            call.enqueue(new Callback<NewsCategoryList>()
            {
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    if (response.isSuccessful())
                    {
                        ...
                        sports_list = response.body().getSports();
                        ...
                        if (sports_list != null)
                        {
                            ...
                            sports_adapter = new ListingsAdapterUrdu(getActivity(), sports_list, "Sports");
                            sports_recycle.setAdapter(sports_adapter);
                            DataCacheUrdu.saveSportsList(getActivity(), sports_list);
    ...
    private void fetchSportsIfNotif()
    {
