 ...
 */
public class MoreUrduFeaturesAdapter extends RecyclerView.Adapter<MoreUrduFeaturesAdapter.ViewHolder>
{
    ...
    public MoreUrduFeaturesAdapter(ArrayList<Contact> contactList, Context context)
    {
    ...
    @Override
    public MoreUrduFeaturesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {

        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        return checkScreenAndSetLayout(inflater, parent);
    }

    private ViewHolder checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup parent)
    {
        ...
        {
            View headerView = inflater.inflate(R.layout.list_item_card_big_urdu_large, parent, false);
        ...
        {
            View headerView = inflater.inflate(R.layout.list_item_card_big_urdu, parent, false);
            return new ViewHolder(headerView)
            {
            };
        }
    ...
    @Override
    public void onBindViewHolder(MoreUrduFeaturesAdapter.ViewHolder holder, final int position)
    {
