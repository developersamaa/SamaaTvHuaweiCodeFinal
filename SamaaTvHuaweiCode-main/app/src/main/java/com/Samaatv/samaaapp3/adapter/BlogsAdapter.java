...
public class BlogsAdapter extends RecyclerView.Adapter<BlogsAdapter.ViewHolder>
{
    ...
    public BlogsAdapter(Context context, ArrayList<Contact> contactList)
    {
    ...
    @Override
    public BlogsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(BlogsAdapter.ViewHolder viewHolder, final int i)
    {
