...
public class SportsNews extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    String sportNewsCat;
    private ListingsAdapter sports_adapter;
    ...
    private void fetchSportsListPreference()
    {
        ...
        sports_list = DataCache.retrieveSportsList(getActivity());

        if (sports_list != null)
        {
            sports_adapter = new ListingsAdapter(getActivity(), sports_list, "Sports");
    ...
    public void onResume()
    {
        ...
        new Handler().postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                SamaaAppAnalytics.getInstance().trackScreenView("Sports News English");
                SamaaFirebaseAnalytics.syncSamaaAnalytics(getActivity(), "Sports News English");
            }
        }, 6000);
    ...
    private void fetchSportsList()
    {
        if (InternetConnection.checkConnection(getActivity()))
        {
            ...
            Call<NewsCategoryList> call = api.getSportsNews();
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    if (response.isSuccessful())
                    {
                        ...
                        if (sports_list != null)
                        {
                            ...
                            sports_adapter = new ListingsAdapter(getActivity(), sports_list, "Sports");
                            sports_recycle.setAdapter(sports_adapter);
                            DataCache.saveSportsList(getActivity(), sports_list);
