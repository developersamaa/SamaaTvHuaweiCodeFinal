...
public class BlogsAdapterUrdu extends RecyclerView.Adapter<BlogsAdapterUrdu.ViewHolder>
{
    ...
    public BlogsAdapterUrdu(Context context, ArrayList<Contact> contactList)
    {
    ...
    @Override
    public BlogsAdapterUrdu.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    private ViewHolder checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup viewGroup, int i, Context context)
    {
        ...
        if (diagonalInches >= 6.5)
        {
            ...
            {
                View normalRow = inflater.inflate(R.layout.items_new_urdu_large, viewGroup, false);
        ...
        else
        {
            ...
            {
                View normalRow = inflater.inflate(R.layout.items_new_urdu, viewGroup, false);
                return new ViewHolder(normalRow)
                {
                };
            }
    ...
    @Override
    public void onBindViewHolder(BlogsAdapterUrdu.ViewHolder viewHolder, final int i)
    {
    ...
    public int getItemCount()
    {
        ...
        else if (contactList != null && contactList.size() < 3)
        {
