...
public class MostWatchedAdapter extends RecyclerView.Adapter<MostWatchedAdapter.ViewHolder>
{
    ...
    public MostWatchedAdapter(Context context, ArrayList<Contact> contactList)
    {
    ...
    @Override
    public MostWatchedAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
    ...
    private ViewHolder checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup viewGroup, int i, Context context)
    {
        ...
        if (diagonalInches >= 6.5)
        {
            ...
            {
                View view = inflater.inflate(R.layout.list_item_card_foot_large, viewGroup, false);
                return new ViewHolder(view)
                {
                };
            }
        ...
        else
        {
            ...
            {
                View view = inflater.inflate(R.layout.list_item_card_foot, viewGroup, false);
                return new ViewHolder(view)
                {
                };
            }
    ...
    @Override
    public void onBindViewHolder(MostWatchedAdapter.ViewHolder viewHolder, final int i)
    {
...
//                    .into(viewHolder.imageView);
        ...
        mPublisherAdView.setAdUnitId(context.getString(R.string.live_en_mrec2));
