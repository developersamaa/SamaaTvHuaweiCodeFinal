...
public class MoreFeaturesUrdu extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    {
        weirdList = DataCacheUrdu.retrieveWeirdList(getActivity());
        if (weirdList != null)
        {
            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(weirdList, context);
            listWeird.setAdapter(muAdapter);
    ...
    {
        scitechList = DataCacheUrdu.retrieveSciList(getActivity());
        if (scitechList != null)
        {
            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(scitechList, context);
            listSci.setAdapter(muAdapter);
            DevicePreference.getInstance().setmContext(getActivity());
    ...
    {
        socialList = DataCacheUrdu.retrieveSocialList(getActivity());
        if (socialList != null)
        {
            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(socialList, context);
            listSocial.setAdapter(muAdapter);
            DevicePreference.getInstance().setmContext(getActivity());
    ...
    {
        lifeList = DataCacheUrdu.retrieveLifeList(getActivity());
        if (lifeList != null)
        {
            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(lifeList, context);
            listLife.setAdapter(muAdapter);
            DevicePreference.getInstance().setmContext(getActivity());
    ...
    {
        healthList = DataCacheUrdu.retrieveHealthList(getActivity());
        if (healthList != null)
        {
            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(healthList, context);
            listHealth.setAdapter(muAdapter);
            DevicePreference.getInstance().setmContext(getActivity());
    ...
    private ViewGroup checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup container)
    {
        ...
        {
            rootView = (ViewGroup) inflater.inflate(R.layout.more_features_layout_urdu_large, container, false);
        }
        else
        {
            rootView = (ViewGroup) inflater.inflate(R.layout.more_features_layout_urdu, container, false);
        }
        return rootView;
                ...
                if (response.isSuccessful())
                {
                    if (response.body() != null)
                    {
                        ...
                        if (healthList != null)
                        {
                            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(healthList, context);
                            listHealth.setAdapter(muAdapter);
                            DataCacheUrdu.saveHealthList(getActivity(), healthList);
                ...
                if (response.isSuccessful())
                {
                    if (response.body() != null)
                    {
                        ...
                        if (lifeList != null)
                        {
                            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(lifeList, context);
                            listLife.setAdapter(muAdapter);
                            DataCacheUrdu.saveLifeList(getActivity(), lifeList);
                            swipeLayout.setRefreshing(false);
                        }
                        else
                        {
                ...
                if (response.isSuccessful())
                {
                    if (response.body() != null)
                    {
                        ...
                        if (socialList != null)
                        {
                            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(socialList, context);
                            listSocial.setAdapter(muAdapter);
                            DataCacheUrdu.saveSocialList(getActivity(), socialList);
                            swipeLayout.setRefreshing(false);
                        }
                        else
                        {
                ...
                if (response.isSuccessful())
                {
                    if (response.body() != null)
                    {
                        ...
                        if (scitechList != null)
                        {
                            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(scitechList, context);
                            listSci.setAdapter(muAdapter);
                            DataCacheUrdu.saveSciList(getActivity(), scitechList);
                            swipeLayout.setRefreshing(false);
                        }
                        else
                        {
                ...
                if (response.isSuccessful())
                {
                    if (response.body() != null)
                    {
                        ...
                        if (weirdList != null)
                        {
                            MoreUrduFeaturesAdapter muAdapter = new MoreUrduFeaturesAdapter(weirdList, context);
                            listWeird.setAdapter(muAdapter);
                            DataCacheUrdu.saveWeirdList(getActivity(), weirdList);
                            swipeLayout.setRefreshing(false);
                        }
                        else
                        {
