...
public class EntertainmentNews extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    String enterNewsCat;
    private ListingsAdapter enter_adapter;
    ...
    private void fetchEnterListPreference()
    {
        ...
        enter_list = DataCache.retrieveEnterList(getActivity());

        if (enter_list != null)
        {

            enter_adapter = new ListingsAdapter(getActivity(), enter_list, "Entertainment");
    ...
    public void onResume()
    {
        ...
        new Handler().postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                SamaaAppAnalytics.getInstance().trackScreenView("Entertainment News English");
                SamaaFirebaseAnalytics.syncSamaaAnalytics(getActivity(), "Entertainment News English");
            }
        }, 6000);
    }
    ...
    private void fetchEnterList()
    {
        if (InternetConnection.checkConnection(getActivity()))
        {
            ...
            Call<NewsCategoryList> call = api.getEnterNews();
                ...
                public void onResponse(Call<NewsCategoryList> call, Response<NewsCategoryList> response)
                {
                    ...
                    if (response.isSuccessful())
                    {
                        ...
                        if (enter_list != null)
                        {
                            ...
                            enter_adapter = new ListingsAdapter(getActivity(), enter_list, "Entertainment");
                            enter_recycle.setAdapter(enter_adapter);
                            DataCache.saveEnterList(getActivity(), enter_list);
