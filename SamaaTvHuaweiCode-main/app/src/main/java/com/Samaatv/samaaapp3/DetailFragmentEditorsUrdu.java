...
//    private static JWPlayerView mPlayerView;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        jcVideoPlayerStandard = (JCVideoPlayerStandard) rootView.findViewById(R.id.videoplayer_editor_urdu);
...
//            mPlayerView.setVisibility(View.GONE);
        ...
        if (InternetConnection.checkConnection(getActivity()))
        {
             ...
             * Calling JSON
             */
            Call<NewsCategoryList> call = api.getAlsoURLUrdu(url);
    ...
    private void setAndProcessingAd()
    {
        ...
        mPublisherAdView.setAdUnitId("/14309701/and-ur/editorschoice/and-ur.editorschoice-det.mrec-1");
        ...
        mPublisherAdView1.setAdUnitId("/14309701/and-ur/editorschoice/and-ur.editorschoice-det.mrec-2");
    ...
    private ViewGroup checkScreenAndSetLayout(LayoutInflater inflater, ViewGroup container)
    {
        ...
        if (diagonalInches >= 6.5)
        {
            ...
            rootView = (ViewGroup) inflater.inflate(R.layout.detail_fragment_editors_urdu_large, container, false);
        }
        else
        {
            // smaller device
            rootView = (ViewGroup) inflater.inflate(R.layout.detail_fragment_editors_urdu, container, false);
        }
        return rootView;
    }
